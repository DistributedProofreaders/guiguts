...
sub runtests {
    ...
    ok( ::compare( "tests/testfilebaseline.txt", 'tests/testfilewrapped.txt' ) == 0,
    ...
    ok( 1 == do { ::openfile("tests/testhtml1.txt");      1 }, "openfile on tests/testhtml1.txt" );
    ...
    ok( -e "tests/testhtml1baseline.html", "tests/testhtml1baseline.html exists" );
    ...
    close $infile;
    close $logfile;
    ok( ::compare( "tests/testhtml1baseline.html", 'tests/testhtml1temp.html' ) == 0,
    ...
    ok( not( -e "tests/testhtml1temp.html" ), "Deletion confirmed of tests/testhtml1temp.html" );
    ok( not( -e "tests/testhtml1.html" ),     "Deletion confirmed of tests/testhtml1.html" );

    # Test 2 of HTML generation
    ok( 1 == do { ::openfile("tests/testhtml2.txt");      1 }, "openfile on tests/testhtml2.txt" );
    ...
    ok( -e "tests/testhtml2baseline.html", "tests/testhtml2baseline.html exists" );
    ...
    close $infile;
    close $logfile;
    ok( ::compare( "tests/testhtml2baseline.html", 'tests/testhtml2temp.html' ) == 0,
        "Autogenerate HTML successful" );
    print "begin diff\n";
    ...
    ok( not( -e "tests/testhtml2temp.html" ), "Deletion confirmed of tests/testhtml2temp.html" );
    ok( not( -e "tests/testhtml2.html" ),     "Deletion confirmed of tests/testhtml2.html" );
