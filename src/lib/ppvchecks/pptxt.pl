...
sub scanno_check {
    ...
    my @sl = (
        'lie',    'arid',    'yon',     'bad',     'tip',     'tho',   'arc',   'hut',
        ...
        'cat',    'tram',    'bumbled', 'bead',    'beads',   'hi',    'ho',    'bach',
        'tunes'
    );

    my @sl_pre1923 = (
        "Banged",      "banger",       "Breams",       "carnages",
        "celling",     "clanger",      "has-relief",   "hex",
        "hitman",      "hooka",        "Iamb",         "nans",
        "Or,",         "PUKE",         "ratter",       "SACKED",
        "Spam",        "GOO",          "Ids",          "FOB",
        "ml.",         "Mm",           "oilier",       "Ms",
        "lier",        "tilings",      "docs",         "denned",
        "aa",          "eon",          "bo",           "sonic",
        "ABE",         "Prance",       "clone",        "baud",
        "BO",          "OP",           "euro",         "mom",
        "hi",          "ip",           "ID",           "Bather",
        "mall",        "V'",           "Beading",      "oiler",
        "TUB",         "fanner",       "alt",          "email",
        "ail",         "appeal's",     "Tier",         "winch",
        "BOW",         "TEX",          "mads",         "Primed",
        "tor",         "baa",          "Prom",         "tiling",
        "conies",      "seances",      "Hue",          "teen",
        "arid",        "natter",       "tipper",       "fax",
        "rilled",      "mil",          "tine",         "carne",
        "modem",       "Rut",          "eases",        "Ami",
        "FOE",         "titan",        "rattier",      "Icings",
        "parsed",      "Borne",        "tho",          "OK",
        "j",           "AH",           "scat",         "Hie",
        "PACK",        "Ac",           "gays",         "ms",
        "Tightness",   "nil",          "MEW",          "OS",
        "lores",       "hitter",       "ho",           "stilt",
        "gnus",        "vet",          "arc",          "Twos",
        "verifiable",  "tad",          "/'",           "gel",
        "BOOK",        "fending",      "bur",          "info",
        "ft",          "Thai",         "eave",         "gamed",
        "Rerun",       "loots",        "Bat",          "OX",
        "dement",      "Gist",         "lather",       "Urn",
        "Jet",         "nickered",     "thai",         "Signer",
        "readied",     "easting",      "TEAR",         "nicker",
        "hone",        "eves",         "Hew",          "persona",
        "coining",     "TV",           "welt",         "oat",
        "tins",        "tome",         "porn",         "Cue",
        "HAKE",        "fetal",        "Due",          "fie",
        "Id",          "yon",          "Mile",         "laud",
        "Pact",        "clement",      "Pans",         "ringers",
        "fiat",        "flay",         "sec",          "chanty",
        "awl",         "bis",          "haying",       "ding",
        "nib",         "groat",        "CHARTER",      "tare",
        "gram",        "abort",        "mt",           "helium",
        "lint",        "Bide",         "bat",          "Toe",
        "bum",         "rick",         "anal",         "whore",
        "pare",        "hare",         "ostentations", "roe",
        "Eke",         "rums",         "surfer",       "minder",
        "faking",      "elopes",       "Outs",         "tinder",
        "hack",        "foil",         "Pie",          "Tin",
        "tee",         "Jaw",          "Agues",        "Bate",
        "tile",        "Hose",         "fen",          "Pox",
        "fad",         "mined",        "ringer",       "tut",
        "wag",         "OWE",          "Mend",         "whoa",
        "Bought",      "ton",          "Eves",         "patty",
        "wen",         "hist",         "Bast",         "Ken",
        "trill",       "tier",         "vas",          "Rive",
        "lilted",      "passible",     "IS",           "moat",
        "ban",         "coiner",       "Pate",         "cur",
        "Bays",        "urn",          "mot",          "loth",
        "deliriously", "fin",          "mat",          "Hiss",
        "duets",       "slated",       "harry",        "fake",
        "formers",     "Brawn",        "poof",         "nudes",
        "CHATTER",     "assort",       "Sips",         "righting",
        "clown",       "loft",         "flue",         "Tour",
        "eared",       "hest",         "tire",         "lauds",
        "clays",       "sue",          "mam",          "Bound",
        "ray",         "Airs.",        "dutch",        "nagged",
        "hushes",      "Teachings",    "Arable",       "fee",
        "bead",        "grout",        "hoard",        "parries",
        "lull",        "Jay",          "Pea",          "aft",
        "ramie",       "menus",        "Surd",         "Hushing",
        "sot",         "riot",         "oases",        "cad",
        "gee",         "Bed",          "tilled",       "oar",
        "tames",       "cue",          "rook",         "straggle",
        "tally",       "Tract",        "rill",         "Yak",
        "dosing",      "lone",         "skew",         "bonding",
        "tilt",        "fife",         "thorn",        "Hum",
        "Lot",         "frustrations", "vended",       "burred",
        "hag",         "lees",         "Boot",         "Bach",
        "sadden",      "fads",         "rue",          "diem",
        "Ill",         "hind",         "bailing",      "mow",
        "Pair",        "primes",       "aide",         "wan",
        "oft",         "polities",     "tittered",     "tram",
        "nave",        "Tack",         "Iris",         "snore",
        "Pacing",      "dubs",         "Mold",         "guru",
        "slimmer"
    );
...
sub poetrybq_checks {
    ...
    for ( $lc = 0 ; $lc <= $#lineld ; $lc++ ) {
        ...
        $outofblock = 1
          if ( ( $lineld[$lc] == 0 and $lineln[$lc] > 0 ) and ( $lc + 1 == $#lineln ) );
